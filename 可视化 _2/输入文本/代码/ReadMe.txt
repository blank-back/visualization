...
inputDoc.h，inputDoc.cpp - 文档
这些文件包含 CinputDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CinputDoc::Serialize)。

inputView.h，inputView.cpp - 文档的视图
这些文件包含 CinputView 类。
CinputView 对象用于查看 CinputDoc 对象。
